...
let
  firstToUpper = str: (lib.toUpper (builtins.substring 0 1 str)) + (builtins.substring 1 (builtins.stringLength str) str);
  ...
  bldc-fw = pkgs.callPackage ./bldc-fw.nix { src = bldcSrc; inherit fwBoards; };
